...
public class OrderVo {
    ...
    private Integer paymentType;  // 付款类型--支付宝支付

    private String paymentTypeDesc;   // 付款类型描述--在线支付
    ...
    private ShippingVo shippingVo;  // 查看订单详情时，查看具体的收货地址
